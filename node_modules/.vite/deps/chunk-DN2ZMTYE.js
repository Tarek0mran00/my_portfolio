...
var QuadTree = class _QuadTree {
  ...
  subdivide() {
    ...
    this._NE = new _QuadTree(new Rectangle(x, y, w / 2, h / 2), capacity);
    this._NW = new _QuadTree(new Rectangle(x + w / 2, y, w / 2, h / 2), capacity);
    this._SE = new _QuadTree(new Rectangle(x, y + h / 2, w / 2, h / 2), capacity);
    this._SW = new _QuadTree(new Rectangle(x + w / 2, y + h / 2, w / 2, h / 2), capacity);
    this._divided = true;
  }
};
...
//# sourceMappingURL=chunk-DN2ZMTYE.js.map
