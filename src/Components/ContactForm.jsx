...
>
      <div>
        <h2
          ...
          className="message text-7xl bg-primary-100 p-2 rounded-xl text-grayscale-200 text-center rounded-br-[0%] relative shadow-2xl"
        >
      ...
      <div className="w-full flex justify-center">
        ...
        >
          ...
          <div className="w-full flex justify-center">
          <input
            className="w-[100px] h-[50px] bg-primary-700 rounded-xl cursor-pointer hover:bg-primary-700 mb-5"
            type="submit"
