          ...
          <div className="w-full md:w-[50%] md:h-full flex items-center mt-100">
            <LazyMotion features={domAnimation} strict>
              <m.p
                ...
                style={{ fontFamily: "Poppins, sans-serif", color: 'white' }} // White text color
                className="text-grayscale-50 p-6 text-center flex flex-col gap-5"
              >
                <span className="text-white" style={{ fontSize: '1.2em', fontWeight: '900' }}>{introduction.text[0]}</span>
                <span className="text-white" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[1]}</span>
                <span className="text-white" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[2]}</span>
                <span className="text-white" style={{ fontSize: '0.95em', fontWeight: '500'}}>{introduction.text[3]}</span>
                <a href="cv/myCV.pdf" download>
                  <span className="text-white" style={{ fontSize: '0.95em', fontWeight: '700'}}>
